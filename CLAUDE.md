...
- Cross-session Claude memory for this project lives in a separate private repo: [cyph3rpuNk-dev/razer-control-memory](https://github.com/cyph3rpuNk-dev/razer-control-memory) (durable facts not derivable from the code — environment quirks, milestone gates, working preferences).
